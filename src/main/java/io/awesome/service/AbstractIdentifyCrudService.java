...
public abstract class AbstractIdentifyCrudService<ID, M extends BaseModel<ID>, L extends ListableID<E, ID>, E extends EditableID<ID>>
    extends AbstractIdentifyService<M, ID> {

  public AbstractIdentifyCrudService(Class<M> modelClass, AbstractIdentifyDao<M, ID> dao) {
