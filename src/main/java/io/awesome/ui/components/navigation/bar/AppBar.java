package io.awesome.ui.components.navigation.bar;
...
import io.awesome.ui.components.navigation.tab.NaviTab;
import io.awesome.ui.components.navigation.tab.NaviTabs;
import io.awesome.ui.layout.SidebarLayout;
...
public class AppBar extends Header {
  ...
  private void initAvatar() {
    ...
    avatar.setSrc(UIUtil.IMG_PATH + "avatar.png");
    avatar.setAlt("User menu");
    welcomeMessage = new Span();
    var userSession =
        (UserSessionDto) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
    welcomeMessage.setText("Hello, " + userSession.getUsername());
  ...
  private void initContainer() {
    container =
        new FlexBoxLayout(
            menuIcon, contextIcon, this.title, search, actionItems, welcomeMessage, avatar);
